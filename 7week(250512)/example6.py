"""
# 예제6 : 깊은 다층 퍼셉트론으로 CIFAR-10 인식하기
"""
...
## 예제 5와 저장되는 모델의 이름이 겹쳐서 변경함(dmlp_trained.h5 -> dmlp_trained_cifar10.h5)
dmlp.save('dmlp_trained_cifar10.h5')
